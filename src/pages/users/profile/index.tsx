            ...
            <Box className={classes.userProfileDetial}>
              ...
              {user.clientName && (
                <Box mt={2} textAlign="center">
                  <Box>
                    <span className={classes.profileDetailInfo}>Company URL:</span>
                    {user.companyUrl}
                  </Box>
                  <Box>
                    <span className={classes.profileDetailInfo}>Phone number:</span>
                    {user.phoneNumber}
                  </Box>
              ...
              {user.userName && (
                <Box mt={2} textAlign="center">
                  <Box>
                    <span className={classes.profileDetailInfo}>User Role:</span>
                    {user.role}
                  </Box>
