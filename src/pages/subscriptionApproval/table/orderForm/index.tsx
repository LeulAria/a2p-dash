...
export default function OrderForm({
  ...
  const signUpFields = [
    ...
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "3",
          message: "company name should not be less than 3 characters",
        },
      },
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "2",
          message: "address name should not be less than 2 characters",
        },
      },
    },
    {
      ...
      rules: {
        minLength: {
          value: "2",
          message: "adress name should not be less than 2 characters",
        },
      },
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "2",
          message: "city should not be less than 2 characters",
        },
      },
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "2",
          message: "State should not be less than 2 characters",
        },
      },
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "2",
          message: "Country name should not be less than 2 characters",
        },
      },
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "4",
          message: "post code should not be less than 4 characters",
        },
      },
    },
    ...
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "4",
          message: "vat number should not be less than 4 characters",
        },
      },
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "4",
          message: "tin number should not be less than 4 characters",
        },
      },
    },
    {
    ...
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "4",
          message: "FullName name should not be less than 4 characters",
        },
      },
    },
    {
    ...
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "4",
          message: "Senders Id should not be less than 4 characters",
        },
      },
    },
    {
    ...
    },
    {
      ...
      rules: {
        ...
        minLength: {
          value: "6",
          message: "Password sould not be less than 6 characters",
        },
      },
    },
  ];
  ...
  const { loading: loadingUser, mutate: mutateUser } = useFireMutation("users");

  const { loading: loadingOrder, mutate: mutateOrder } = useFireMutation("orders");
